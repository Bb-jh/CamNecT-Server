...
public class QExternalActivity extends EntityPathBase<ExternalActivity> {
    ...
    private static final long serialVersionUID = -83770880L;
    ...
    public final EnumPath<ActivityCategory> category = createEnum("category", ActivityCategory.class);
    ...
    public final EnumPath<ActivityStatus> status = createEnum("status", ActivityStatus.class);
